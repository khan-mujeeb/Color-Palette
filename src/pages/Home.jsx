    ...
    return (
        <div className="flex h-[90%] px-5">
            <div className="flex flex-col w-[40%] gap-10 justify-center items-center">
                <h1 className=" text-center text-7xl font-bold">The superfast Color Palettes generator!</h1>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    >Generate Palettes from Image</button>
                    <button className={`${styles.button} bg-white text-black border border-gray-400`}>Explore trending palettes</button>
                </div>
            </div>
